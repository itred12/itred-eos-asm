...
#class PatchHandler(AbstractPatchHandler, DependantPatch): # If the patch uses overlay 36, comment the above line and uncomment this line.
    ...
    @property
    def name(self) -> str:
        return 'LinkShopBudgeting'

    @property
    def description(self) -> str:
        return "Allows you to change the cost of a link session in the Electivire Link Shop."
